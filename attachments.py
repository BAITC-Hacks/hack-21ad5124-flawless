...
EXTENSIONS = {".jpg": "image", ".jpeg": "image", ".png": "image", ".webp": "image", ".pdf": "pdf",
              ".docx": "docx", ".xlsx": "xlsx"}
MIME = {"image": {"image/jpeg", "image/png", "image/webp"}, "pdf": {"application/pdf"},
    ...
    for item, data in decoded:
        ...
        if extension in {".doc", ".xls", ".docm", ".xlsm"}:
            ...
            failure = "Формат файла не поддерживается. " + FORMAT_HINT
                ...
                expected == "image" and kind != "image/jpeg" and extension in {".jpg", ".jpeg"}) or (
                expected == "image" and kind != "image/webp" and extension == ".webp") or kind != expected and expected != "image":
