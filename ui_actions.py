...
COPY = {
    "ru": {
        "add_to_cart": ("Добавить", "Добавь {qty} шт {product} в корзину"),
        "show_analogs": ("Похожие варианты", "Покажи аналоги для {product}"),
        "show_details": ("Характеристики", "Покажи характеристики товара {product}"),
        "show_availability": ("Наличие по городам", "Покажи наличие товара {product} по складам"),
        "show_certificates": ("Сертификаты", "Покажи сертификаты товара {product}"),
        ...
        "cheaper_options": ("Подобрать дешевле", "Подбери более дешёвый вариант для {product}"),
        "other_brand": ("Другой производитель", "Покажи похожий товар другого производителя вместо {product}"),
        ...
        "change_quantity": ("Изменить количество", "Измени количество {product} в корзине на {qty} шт"),
        "remove_from_cart": ("Удалить товар", "Удали {product} из корзины"),
        "clear_cart": ("Очистить корзину", "Очисти корзину"),
    },
    "kk": {
        "add_to_cart": ("Себетке қосу", "{product} тауарынан {qty} дана себетке қос"),
        "show_analogs": ("Ұқсас нұсқалар", "{product} тауарына ұқсас нұсқаларды көрсет"),
        "show_details": ("Сипаттамалар", "{product} тауарының сипаттамаларын көрсет"),
        "show_availability": ("Қалалардағы қор", "{product} тауарының қоймалардағы қорын көрсет"),
        "show_certificates": ("Сертификаттар", "{product} тауарының сертификаттарын көрсет"),
        ...
        "cheaper_options": ("Арзанырақ нұсқа", "{product} тауарына арзанырақ балама тап"),
        "other_brand": ("Басқа өндіруші", "{product} орнына басқа өндірушінің ұқсас тауарын көрсет"),
        ...
        "change_quantity": ("Санын өзгерту", "Себеттегі {product} тауар санын {qty} данаға өзгерт"),
...
def build_actions(proposals: list[dict], reply: str, latest: str, catalog: Catalog,
    ...
    for raw in proposals[:30]:
        ...
        message = message.replace("{product}", str(product.get("name") or article) if product else "")
